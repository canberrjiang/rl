...
datasetA_name = 'a3/data_wrangling_rl1_2022_u5885254.csv'
datasetB_name = 'a3/data_wrangling_rl2_2022_u5885254.csv'
...
truthfile_name = 'a3/data_wrangling_rlgt_2022_u5885254.csv'
...
# attribute lists)
#
blocking_attrA_list = [3, 4, 5, 9]
blocking_attrB_list = [3, 4, 5, 9]
...
approx_comp_funct_list = [(comparison.jaro_winkler_comp, 1, 1),        # First name
                          ...
                          (comparison.exact_comp, 4, 4),  # Gender
                          (comparison.compareNumericValues, 5, 5),  # Age
                          (comparison.compareDateValues, 6, 6),  # Dob
                          (comparison.edit_dist_sim_comp, 7, 7),   # Address
                          (comparison.edit_dist_sim_comp, 8, 8),  # Suburb
                          (comparison.edit_dist_sim_comp, 9, 9),  # Postcode
                          (comparison.exact_comp, 10, 10),          # State
                          (comparison.comparePhone, 11, 11),  # Phone
...
#
# weight_vec = [3.0, 1.0, 5.0, 5.0, 5.0, 5.0, 1.0, 1.0, 1.0, 1.0, 3.0, 3.0]
...
saveLinkResult.save_linkage_set('dtclassification', class_match_set)
# -----------------------------------------------------------------------------
